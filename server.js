...
/*------------------路由配置--------------------------------*/
var routes = {
  '/loadNews.json': function(staticPath,req,res){
  ...
  '/loadMore': function(staticPath,req,res){
   ...
   '/zhubao.json': function(staticPath,req,res){
              readFile(path.join(staticPath,'src','zhubao.json'),req,res);
                }

  //页面
   /*'/fenye.html':function(staticPath,req,res){
              console.log('?///////////////////fenye.html')
              readFile(path.join(staticPath,'fenye.html'),req,res);
                },
   '/loadNew.html':function(staticPath,req,res){
              readFile(path.join(staticPath,'loadNew.html'),req,res);
                },
   '/loadMore.html':function(staticPath,req,res){
              readFile(path.join(staticPath,'loadMore.html'),req,res);
                },
   '/zhubao.html':function(staticPath,req,res){
                      ...
                      //fileContent 是JSON格式的字符串，转为数组                  
                       ...
                       /* console.log(curIndex);
                        ...
                        // 与前端约定的是JSON格式      
                          ...
                          Mime(req,res);
                          // 方式2 Access-Control-Allow-Origin 形式支持ajax跨域请求
                          if(req.headers.origin){
                              res.setHeader('Access-Control-Allow-Origin',req.headers.origin)
                           } 

                           res.setHeader('Set-Cookie','name=xxx;domain=.test.com;')
